class Rational { 
    ...
    public boolean equals(Object x) {
        ...
        simplestForm();
        y.simplestForm();
        if(y.numerator == numerator&& y.denominator == denominator){
            return true;
        }
        else
            return false;
    ...
    public long compareTo(Object x) {
        ...
        y.simplestForm();
        //less
        if ((numerator*y.denominator)<(denominator*y.numerator)){
            return -1;
        } else if ((numerator*y.denominator)>(denominator*y.numerator)){
            return 1;
        } else
            return 0;
    }
